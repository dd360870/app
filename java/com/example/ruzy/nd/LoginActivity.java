...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mRegisterButton = (Button) findViewById(R.id.email_register);
    ...
    private void emailDialog() {
        final View view = LayoutInflater.from(LoginActivity.this).inflate(R.layout.dialog_email, null);
